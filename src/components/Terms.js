...
function Terms() {
  return (
    <div className="terms">
      ...
      <p style={{ color: 'white' }}>Last updated on 07-10-2024 22:39:48</p>
      
      <h2 style={{ color: 'white' }}>1. Agreement</h2>
      <p style={{ color: 'white' }}>
        These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding agreement by and between HRITIK SAGAR SRIVASTAVA, (“Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, “Services”).
      </p>
      
      <h2 style={{ color: 'white' }}>2. Acceptance of Terms</h2>
      <p style={{ color: 'white' }}>
        By using our website and availing the Services, you agree that you have read and accepted these Terms (including the Privacy Policy). We reserve the right to modify these Terms at any time and without assigning any reason. It is your responsibility to periodically review these Terms to stay informed of updates.
      </p>
      
      <h2 style={{ color: 'white' }}>3. Terms of Use</h2>
      <ul style={{ color: 'white' }}>
        ...
        <li>
          All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Prayagraj, Uttar Pradesh.
        </li>
        <li>
